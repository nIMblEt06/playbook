      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="px-6 py-6 border-b-2 border-border">
          <div className="flex items-center gap-3 mb-6">
            <div className="w-12 h-12 bg-primary border-2 border-border-strong flex items-center justify-center">
              <Library className="w-6 h-6 text-primary-foreground" />
            </div>
            <div>
              <h1 className="text-3xl font-bold uppercase">MY LIBRARY</h1>
              <p className="text-sm text-muted-foreground">Your saved posts and playlists</p>
            </div>
          </div>

          {/* Tabs */}
          <div className="flex gap-2 border-2 border-border w-fit">
            <button
              onClick={() => setActiveTab('spotify')}
              className={`flex items-center gap-2 px-4 py-2 font-medium uppercase text-sm transition-all ${
                activeTab === 'spotify'
            ...
            <div className="p-6">
              {spotifyPlaylistsLoading ? (
                ...
                <div className="py-20 text-center">
                  ...
                  <h3 className="text-lg font-bold mb-2 uppercase">Error Loading Spotify Playlists</h3>
                ...
                <div className="py-20 text-center">
                  ...
                  <h3 className="text-lg font-bold mb-2 uppercase">No Spotify Playlists</h3>
                  ...
                  <a
                    ...
                    className="inline-flex items-center gap-2 px-4 py-2 bg-[#1DB954] text-white font-medium uppercase text-sm border-2 border-[#1DB954] hover:bg-[#1ed760] transition-all"
                  >
                  ...
                  {spotifyPlaylists.items.map((playlist: SpotifyPlaylist) => (
                    ...
                    >
                      <div className="bg-card border-2 border-card-border hover:border-[#1DB954] transition-all hover:shadow-md">
                        ...
                        {/* Info */}
                        <div className="p-4">
                          <h3 className="font-bold text-base uppercase truncate mb-1">
                            {playlist.name}
                          </h3>
            ...
            <div>
              {savedPostsLoading ? (
                ...
                <div className="px-6 py-20 text-center">
                  ...
                  <h3 className="text-lg font-bold mb-2 uppercase">Error Loading Saved Posts</h3>
                  <p className="text-sm text-muted-foreground">
                ...
                <div className="px-6 py-20 text-center">
                  ...
                  <h3 className="text-lg font-bold mb-2 uppercase">No Saved Posts</h3>
                  <p className="text-sm text-muted-foreground mb-4">
                    Save posts you like to access them later
                  </p>
                  <Link
                    href="/"
                    className="inline-flex items-center gap-2 px-4 py-2 bg-primary text-primary-foreground font-medium uppercase text-sm border-2 border-border-strong hover:shadow-primary transition-all"
                  >
                    Explore Posts
                  </Link>
                </div>
            ...
            <div className="p-6">
              {playlistsLoading ? (
                ...
                <div className="py-20 text-center">
                  ...
                  <h3 className="text-lg font-bold mb-2 uppercase">Error Loading Playlists</h3>
                  <p className="text-sm text-muted-foreground">
                ...
                <div className="py-20 text-center">
                  ...
                  <h3 className="text-lg font-bold mb-2 uppercase">No Playlists Yet</h3>
                  <p className="text-sm text-muted-foreground mb-4">
                    Create your first playlist to organize your favorite tracks
                  </p>
                  <button className="inline-flex items-center gap-2 px-4 py-2 bg-primary text-primary-foreground font-medium uppercase text-sm border-2 border-border-strong hover:shadow-primary transition-all">
