...
import {
  ...
  useUpvotePostComment,
} from '@/lib/hooks/use-posts'
import type { PostComment } from '@/lib/api/services/posts'
...
function PostCommentItem({
  ...
  const upvoteCommentMutation = useUpvotePostComment()
...
export function PostCommentThread({
  ...
  return (
    <div className="mt-2 bg-card border-2 border-border overflow-hidden">
      {/* Header */}
